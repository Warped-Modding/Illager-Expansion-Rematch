...
public class HatIllagerEntityModel<T extends IllagerEntity> extends SinglePartEntityModel<T> implements ModelWithArms, ModelWithHead
{
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData2.addChild("lower_hat", ModelPartBuilder.create().uv(0, 64).cuboid(-7.0f, -10.0f, -7.0f, 14.0f, 1.0f, 14.0f), ModelTransform.pivot(0.0f, -1.0f, 0.0f));
        modelPartData2.addChild("middle_hat", ModelPartBuilder.create().uv(0, 80).cuboid(-4.0f, -19.76f, -4.0f, 8.0f, 10.0f, 8.0f, new Dilation(-0.05f)), ModelTransform.of(0.0f, -1.0f, 0.0f, -0.05f, 0.0f, 0.0f));
        modelPartData2.addChild("upper_hat", ModelPartBuilder.create().uv(0, 98).cuboid(-4.0f, -19.76f, 3.9f, 8.0f, 5.0f, 5.0f, new Dilation(-0.05f)), ModelTransform.of(0.0f, -1.0f, 0.0f, -0.05f, 0.0f, 0.0f));
